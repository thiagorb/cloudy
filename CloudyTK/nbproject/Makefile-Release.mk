...
${OBJECTDIR}/_ext/248921411/tunnel.o: ../../../Área\ de\ trabalho/Cloudy/CloudyTK/tunnel.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/248921411/tunnel.o ../../../Área\ de\ trabalho/Cloudy/CloudyTK/tunnel.c

${OBJECTDIR}/_ext/248921411/bytestream.o: ../../../Área\ de\ trabalho/Cloudy/CloudyTK/bytestream.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/248921411
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/248921411/bytestream.o ../../../Área\ de\ trabalho/Cloudy/CloudyTK/bytestream.c

${OBJECTDIR}/cloudy_layout.o: cloudy_layout.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/cloudy_layout.o cloudy_layout.c

${OBJECTDIR}/_ext/248921411/cloudy_widgets.o: ../../../Área\ de\ trabalho/Cloudy/CloudyTK/cloudy_widgets.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/248921411
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/248921411/cloudy_widgets.o ../../../Área\ de\ trabalho/Cloudy/CloudyTK/cloudy_widgets.c

${OBJECTDIR}/_ext/248921411/socket.o: ../../../Área\ de\ trabalho/Cloudy/CloudyTK/socket.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/248921411
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/248921411/socket.o ../../../Área\ de\ trabalho/Cloudy/CloudyTK/socket.c

${OBJECTDIR}/mutex.o: mutex.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/mutex.o mutex.c

${OBJECTDIR}/_ext/248921411/command.o: ../../../Área\ de\ trabalho/Cloudy/CloudyTK/command.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/248921411
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/248921411/command.o ../../../Área\ de\ trabalho/Cloudy/CloudyTK/command.c

${OBJECTDIR}/_ext/248921411/pipe.o: ../../../Área\ de\ trabalho/Cloudy/CloudyTK/pipe.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/248921411
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/248921411/pipe.o ../../../Área\ de\ trabalho/Cloudy/CloudyTK/pipe.c

${OBJECTDIR}/_ext/248921411/cloudy_app.o: ../../../Área\ de\ trabalho/Cloudy/CloudyTK/cloudy_app.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/248921411
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/248921411/cloudy_app.o ../../../Área\ de\ trabalho/Cloudy/CloudyTK/cloudy_app.c

${OBJECTDIR}/interface.o: interface.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/interface.o interface.c
